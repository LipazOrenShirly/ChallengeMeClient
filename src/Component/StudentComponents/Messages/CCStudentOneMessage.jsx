        ...
        return (
            <div>
                ...
                {message.messageByTeacher &&
                    <div style={{textAlign:"right"}} className = 'incomingMessage'> -הודעה נכנסת- {message.messageText}</div>
                    // להציג תאריך ושעה לכל הודעה
                }

                {message.messageByTeacher == false &&
                    <div style={{textAlign:"left"}} className = 'outgoingMessage'> -הודעה יוצאת- {message.messageText}</div>
                    // להציג תאריך ושעה לכל הודעה
                }
            </div>
        );
